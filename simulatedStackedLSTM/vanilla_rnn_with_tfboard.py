...
with tf.name_scope('rnn_weights'):
    ...
    with tf.name_scope("Bias"):
        ...
        print("b_rnn shape: ", np.shape(b_rnn))        
...
print("processed_input shape: ", np.shape(processed_input))
...
print("all_hidden_states: ", np.shape(all_hidden_states ))
...
with tf.Session() as sess:
    ...
    for i in range(2):
            ...
            print("batch_x: ", np.shape(batch_x), " batch_y: ", np.shape(batch_y))
