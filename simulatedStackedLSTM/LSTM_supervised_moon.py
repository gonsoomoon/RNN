...
with tf.Session() as sess:
    ...
    print("states_example[0][1][1][0:3] ", states_example[0][1][1][0:3] )    
    print("states_1_example[0][1][0:3]] ", states_1_example[0][1][0:3])

    # The last state as state[1] is the same as output example
    
    # output_example shape:  (1, 128, 6, 32)
    # states[1] shape:  (1, 128, 32)
    # states shape:  (1, 2, 128, 32)    
    # output_example[0][1][0:6,0:3]  
    # [[-0.43154937 -0.56582701  0.31144461]
    # [-0.80850387 -0.80726999  0.51292574]
    # [-0.81297642 -0.84312087  0.56904751]
    # [ 0.          0.          0.        ]
    # [ 0.          0.          0.        ]
    # [ 0.          0.          0.        ]]
    # states_example[0][1][1][0:3]  [-0.81297642 -0.84312087  0.56904751]
    # states_1_example[0][1][0:3]]  [-0.81297642 -0.84312087  0.56904751]
